...
<ul>
  ...
  <li>AI Response Automation</li>
  <li>Google Sheets Automation</li>
  <li>WhatsApp / Messenger Automation</li>
</ul>

<p>More workflows will be added regularly.</p>
...
<ol>
  ...
  <li>Select <strong>"From File"</strong></li>
  <li>Upload the downloaded JSON file</li>
  <li>Click <strong>"Import"</strong></li>
  <li>Update credentials (API keys, tokens, etc.)</li>
...
<ul>
  ...
  <li>Required API credentials (if used)</li>
  <li>Basic knowledge of n8n nodes</li>
</ul>
